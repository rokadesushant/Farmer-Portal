...
$query = "select p.productname,sum(bp.quantity) as number from product p,buyerproduct bp where bp.productid=p.productid and bp.buyerid=".$rowid." GROUP BY productname";  
     ...
     <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            Copyright &copy; Cropify 2020<span id="google_translate_element" class="text-right"></span>
