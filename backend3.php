...
if(isset($_POST['readrecords'])){
	...
	$displayquery = " SELECT * FROM `user` where id='$rowid'"; 
...
if(isset($_POST['hidden_user_id']))
{
    ...
    $query = "UPDATE user SET firstname = '$firstname',lastname = '$lastname', email = '$email',username = '$username', phoneno = '$phoneno', address = '$address' ,state='$state',city = '$city',latitude='$lat',longitude = '$long' WHERE id = '$rowid' ";
    if (!$result = mysqli_query($link,$query)) {
        exit(mysqli_error());
    }
}
