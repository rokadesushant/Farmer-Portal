...
<body class="bg-gradient-primary"><br><br>
  <div class="container">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="validate.php">
                    <input type="radio" name="type" id="farmer" value="farmer" checked> Farmer
                    <input type="radio" name="type" id="buyer" value="buyer"> Buyer
                    <input type="radio" name="type" id="transport" value="transport"> Transporter<br>
